...
int main(void)
{
  ...
  if (C0.setPort(1,andAbr,2)) cerr << "Deveria dar erro\n";
  ...
  if (C0.setPort(-1,norAbr,3)) cerr << "Deveria dar erro 1\n";
  if (C0.setPort(0,norAbr,3)) cerr << "Deveria dar erro 2\n";
  if (C0.setPort(3,norAbr,3)) cerr << "Deveria dar erro 3\n";
  // Inicializa a porta Id==1 (valores invalidos e validos)
  if (C0.setPort(1,erro1,3)) cerr << "Deveria dar erro 4\n";
  if (C0.setPort(1,norAbr,1)) cerr << "Deveria dar erro 5\n";
  if (!C0.setPort(1,norAbr,3)) cerr << "Nao deveria dar erro 6\n";
  // Inicializa a porta Id==2 (valores invalidos e validos)
  if (C0.setPort(2,notAbr,2)) cerr << "Deveria dar erro 7\n";
  if (!C0.setPort(2,notAbr,1)) cerr << "Nao deveria dar erro 8\n";
  ...
  if (!C2.setPort(1,nxorAbr,2)) cerr << "Nao deveria dar erro 25\n";
  // As duas entradas da porta Id==1 veem das entradas -1 e -2 do circuito
